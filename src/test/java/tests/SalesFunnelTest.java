...
public class SalesFunnelTest extends BaseTest {
    ...
    public static Object[][] carsDataProvider() {
        return new Object[][]{
            ...
            {new Car("FORD", "Sierra", "Limousine", "Benzin", "150 kW / 204 PS", "SIERRA RS COSWORTH", "HSN: 0928, TSN: 684")},
            {new Car("FORD", "Scorpio", "Kombi", "Diesel", "85 kW / 116 PS", "SCORPIO TURNIER DIESEL", "HSN: 0928, TSN: 859")},
